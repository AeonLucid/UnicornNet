...
namespace UnicornNet
{
    public static class UcNative
    {
        ...
        /// </returns>
        [DllImport(LibraryName, EntryPoint = "uc_version")]
        ...
        [DllImport(LibraryName, EntryPoint = "uc_arch_supported")]
        ...
        [DllImport(LibraryName, EntryPoint = "uc_open")]
        ...
        /// <returns>UC_ERR_OK on success, or other value on failure.</returns>
        [DllImport(LibraryName, EntryPoint = "uc_close")]
        ...
        [DllImport(LibraryName, EntryPoint = "uc_query")]
        ...
        /// <param name="engine">handle returned by uc_open()</param>
        /// <returns>error code of uc_err enum type (UC_ERR_*, see above)</returns>
        [DllImport(LibraryName, EntryPoint = "uc_errno")]
        ...
        [DllImport(LibraryName, EntryPoint = "uc_hook_add")]
